...
const Experience = () => {
    ...
    return (
        <section className=" mt-5 pt-5">   <h2>Experience & Education</h2>
            ...
            <div className="row    ">
                ...
                <div className="col-md-5 wait   p-3 m-3  box">
                   <ul>
                    ...
                    <b><li><img src="https://img.icons8.com/external-glyph-geotatah/20/000000/external-academic-knowledge-management-glyph-glyph-geotatah.png"/> Bachelor’s  Degree </li> </b> <footer>Institute: I am not admitted anywhere yet. I took 1 year break to know myself. Intend to take admission in December or January <br />(Future) 
                    </footer> 
                    <footer>
                    {/* Passing Year: 2022 - n */}
                     
                    </footer><br />
                    <b><li><img src="https://img.icons8.com/external-flat-geotatah/20/000000/external-academic-knowledge-management-flat-flat-geotatah.png"/> HSC</li> </b> <footer>Institute: Daffodil International College, Chandpur <br /> 
                    </footer> 
                    <footer>
                    2020 - 2022
